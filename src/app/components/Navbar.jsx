...
export default function Navbar({ lang, setLang }) {
  ...
  return (
    <nav className="fixed w-screen top-0 left-0  z-50 bg-white shadow-md">
      {/* Top bar */}
      <div
      ...
      >
        ...
        {/* Desktop Nav */}
        <div
          className={`hidden md:flex items-center gap-x-8 text-3xl 2xl:text-4xl md:gap-x-4 ${
            lang === "en" ? "flex-row" : "flex-row-reverse"
          }`}
        >
          ...
          <select
            ...
            className="outline-none xl:text-[28px] font-Amiri-Regular mx-6 text-[#0f204e] md:mx-3"
          >
