...
export default function ImageSlider({ lang }) {
  return (
    <section className="w-screen bg-white py-10 overflow-hidden flex flex-col items-center">
      <h2 className="p-4 text-4xl font-bold bg-[#0f204e] text-white mb-10 text-center border-[#0f204e]">
        {lang === "en" ? "Clients" : "العملاء"}
      </h2>

      <div className="relative  overflow-hidden">
        <div className="flex gap-6 animate-scroll-slow justify-center items-center ">
          {images.map((src, i) => (
            <div
              key={`set1-${i}`}
